...
function Get-VnetInfo( $SubscriptionName, $Location )
{
  ...
  switch( $SubscriptionName )
  {
    ...
    'Sensitive Dev-Test 2'
    {
      switch( $Location )
      {
        'West US'          { $VnetGroup = 'rxrdts-networkrg'; $VnetName = 'rxr-dts-vnet'      }
        'North Central US' { $VnetGroup = 'rxrncdts-networkrg'; $VnetName = 'rxr-nc-dts-vnet' }
      }
      $VnetGroup = 'dts2-network'; $VnetName = 'ppssuatptwuvnet' 
    }
    ...
    'DevOps'
    {
      switch( $Location )
      {
        'West US'   { $VnetGroup = 'DevOpsNetworkRG'; $VnetName = 'DevOpsVNet' }
      }
    }
  }
